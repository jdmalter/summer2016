...
public final class Partition {
   ...
   public static BigInteger partition(int n, int k) {
      ...
      else return partitionRecursive(n, k);
   }

   /**
    * If {@code n < k} is true, returns 0. If {@code n == k} is true, returns 1.
    * Otherwise, returns the sum of {@code partition(n, k + 1)} and
   ...
   private static BigInteger partitionRecursive(int n, int k) {
      ...
      else if (n == k) return BigInteger.ONE;
